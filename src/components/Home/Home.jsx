  ...
  return (
    <>
      ...
      <section id='home1'>
        ...
        <p className='home-p'>Want to come play? Book your session time with us now!</p>
        <button>BOOK NOW</button>
      </section>
      <Banner image={"/background2.svg"} />
      <section id='home2'>
        <h2>Corporate Wellness and Team Building</h2>
        <p className='home-p'>Looking to bring your workplace or team to Pursuit? We have 30,000 square feet of amazing team building obstacles and activities! We’ll help you plan your trip and our team leaders will make sure everyone in your group has the best time ever!</p>
